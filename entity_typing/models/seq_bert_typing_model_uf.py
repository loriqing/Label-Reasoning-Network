...
from entity_typing.modules import Seq2SeqDecoder, Seq2SeqDecoderUF, Seq2SeqAttnDecoder, Seq2SeqAttn2DecoderUF, Seq2SeqLoss, Seq2SeqTransformerDecoder, Seq2SeqTransformerDecoder2
from entity_typing.constant import NAME_SPACE_SEQ_LABEL, FEATURE_NAME_SEQ_LABEL, EOS_SYMBOL, PADDING_TOKEN

logger = logging.getLogger(__name__)


@Model.register("seq_bert_typing_model_uf")
class SeqBertTypingModelUF(Model):
    def __init__(self,
                 vocab: Vocabulary,
        ...
        if decoder_type == 'lstm2':
            self._decoder = Seq2SeqAttn2DecoderUF(
                vocab=vocab,
                label_field_embedder=self._label_field_embedder,
                label_embedding_dim=self._label_field_embedder.get_output_dim(),
