...
if __name__ == "__main__":
    ...
    args.bert_type = 'sep_mention_kv'
    # args.memory_emb = 'data/glove.6B.300d.txt'
    args.memory_emb = '../probe_experiment/data/glove/glove.ontonotes_all.300d.txt'
    args.memory_emb_size = 300
    args.overwrite_model_path = True
    args.data_folder_path = 'data/ontonotes_original_lemma_synthetic'
    args.epoch = 1
    args.batch = 2
    args.lr = 1e-4
    args.lr_diff = True
    ...
    args.transformer_require_grad = False
    args.lr_diff = True
    args.edit = 0.05
    ...
    args.loss_lambda2 = 1
    args.detach = False
    args.similar_thred = 0.2
    args.value_file = 'probe_experiment/data/onto_ontology.txt'
    args.test_ins = 100
